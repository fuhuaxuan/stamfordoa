...
--4、定义工作流程名称 ，步骤等
  ...
  select v_EntGid, v_ModelGid, v_ModelCode, '物资采购流程', 3, '现代医院', '1.0', 0, 0 from dual;
  ...
  */
  ...
  insert into WF_Task_Define(EntGid, ModelGid, TaskDefGid, Code, Name, Note, OrderValue, IsStart, IsEnd, IsMCF)
  select v_EntGid, v_ModelGid, v_TaskGid_T3, v_ModelCode || '_T3', '总经理','审批', 1, 0, 0, 0 from dual;
