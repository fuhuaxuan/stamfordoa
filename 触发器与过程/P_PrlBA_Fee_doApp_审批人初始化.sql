create or replace procedure P_PrlBA_Fee_doApp(p_EntGid    varchar2, --企业Gid
...
begin
  ...
  if p_AppAssign <> '终止' then
    ...
    commit;
    --取出审批人中重复的审批人
    delete from wf_PrlBA_Fee_App f
     where f.EntGid = p_EntGid
       and f.FlowGid = p_FlowGid
       and f.Apporder > 0
